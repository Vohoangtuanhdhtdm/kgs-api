...
namespace kgs_api.Migrations
{
    ...
    [Migration("20260716094602_Refactor-AddAsset-ver2")]
    partial class RefactorAddAssetver2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.PropertyImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.PropertyImage", b =>
                {
                    b.HasOne("kgs_api.Domain.Entity.Property", "Property")
                        .WithOne("Img")
                        .HasForeignKey("kgs_api.Domain.Entity.SubEntity.PropertyImage", "PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("kgs_api.Domain.ValueObjects.StoredFile", "File", b1 =>
                        {
                            b1.Property<Guid>("PropertyImageId")
                                .HasColumnType("uuid");
